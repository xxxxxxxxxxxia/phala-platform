...
import type { IPool, ISession } from './IncentiveFlow';
...
const LiveData: React.FC<Props> = ({
    workerCount, pools, activeSessions, totalRewards,
        ...
        >
            ...
            <Row gutter={[16, 16]}>
                <Col xs={24} sm={12} md={6}>
                    <Statistic title="Worker数量" value={workerCount} valueStyle={{ color: '#52c41a' }} />
                </Col>
                <Col xs={24} sm={12} md={6}>
